...
subtitle: ''
author: Tsuizen
description: 本文主要介绍了作者在构建个人博客时使用的技术栈和一些实现方法。作者选择了服务端渲染的方式，并使用了React框架Next.js。同时，作者还使用了MDX来处理博客的内容，选择了原子化CSS框架Tailwindcss进行样式设计，并使用了SCSS进行补充。此外，作者还添加了RSS订阅支持，进行了SEO和站点地图的配置，以提高博客的搜索引擎优化效果。
tags:
  - Next.js
  - 前端性能优化
featureImage: ''
